...
getDistance(inputOrigin, inputDestination, manualWeatherButton, realtimeWeatherButton);
...
async function getEVInformation() {
    ...
    inputModel.onchange = () => {
        ...
        document.getElementById('efficiency').textContent = `${EV[0].efficiency} Wh/km`;
    }
}
...
async function getDistance(inputOrigin, inputDestination, manualWeatherButton, realtimeWeatherButton) {
...
function calculateEmission() {
    ...
    okButton.onclick = () => {
        ...
        document.getElementById('totalEmissionResult').textContent = 
            `The total emission of the trip: ${totalEmission} grams of CO2`;
    }
}