...
getCarInformation(
    inputMake_1, inputModel_1, inputVersion_1, inputYear_1, carMakeOptions_1, carModelOptions_1, carVersionOptions_1, carYearOptions_1, emissionElement_1
);

getCarInformation(
    inputMake_2, inputModel_2, inputVersion_2,inputYear_2, carMakeOptions_2, carModelOptions_2, carVersionOptions_2, carYearOptions_2, emissionElement_2
);
...
const temperatureStatement_1 = document.getElementById("temperature_statement_1");
const temperatureStatement_2 = document.getElementById("temperature_statement_2");

getDistanceAndTemperature(inputOrigin_1, inputDestination_1, distanceElement_1, travelTimeElement_1, temperatureStatement_1);
getDistanceAndTemperature(inputOrigin_2, inputDestination_2, distanceElement_2, travelTimeElement_2, temperatureStatement_2);
...
okButton.onclick = () => {
    ...
    let temperature_1 = parseFloat(temperatureStatement_1.textContent.slice(41,45));
    let temperature_2 = parseFloat(temperatureStatement_2.textContent.slice(41,45));
    ...
    let totalEmission_1 = calculateEmission(averageEmission_1, distance_1, temperature_1, travelTime_1, totalEmissionElement_1);
    let totalEmission_2 = calculateEmission(averageEmission_2, distance_2, temperature_2, travelTime_2, totalEmissionElement_2);

    checkSmallerValue(emissionElement_1, emissionElement_2, averageEmission_1, averageEmission_2);
    checkSmallerValue(distanceElement_1, distanceElement_2, distance_1, distance_2);
    checkSmallerValue(travelTimeElement_1, travelTimeElement_2, travelTime_1, travelTime_2);
...
async function getCarInformation(inputMake, inputModel, inputVersion, inputYear, carMakeOptions, carModelOptions, carVersionOptions, carYearOptions, emissionElement) {
    // Fetch the database
...
async function getDistanceAndTemperature(inputOrigin, inputDestination, distanceResult, travelTimeResult, temperatureTextResult) {
...
// Calculate the total emission
function calculateEmission(averageEmission, distance, temperature, travelTime, totalEmissionElement) {
    ...
    let increaseInTemperature = getIncreaseInTemperature(temperature, ENVIRONMENT_EFFECT);
