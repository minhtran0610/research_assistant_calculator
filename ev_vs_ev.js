...
getDistanceAndTemperature(inputOrigin_1, inputDestination_1, distanceResult_1, temperatureStatement_1);
getDistanceAndTemperature(inputOrigin_2, inputDestination_2, distanceResult_2, temperatureStatement_2);
...
okButton.onclick = () => {
    ...
    let totalEmission_1 = calculateEmission(efficiency_1, distance_1, temperature_1, emissionFactor, totalEmissionElement_1);
    let totalEmission_2 = calculateEmission(efficiency_2, distance_2, temperature_2, emissionFactor, totalEmissionElement_2);

    checkSmallerValue(efficiencyElement_1, efficiencyElement_2, efficiency_1, efficiency_2);
...
async function getDistanceAndTemperature(inputOrigin, inputDestination, distanceResult, temperatureTextResult) {
